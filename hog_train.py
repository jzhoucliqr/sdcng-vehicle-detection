...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        # png mpimg read scale: 0,1
        # jpg mpimg read scale: 0,255
...
for image in images:
    cars.append(image)
images = glob.glob('dataudacity/extract/*.jpg')
for image in images:
    cars.append(image)
...
for image in images:
    notcars.append(image)
images = glob.glob('dataudacity/noncar/*.png')
for image in images:
    notcars.append(image)
images = glob.glob('dataudacity/noncar-extract/*.jpg')
for image in images:
    notcars.append(image)
...
svr = svm.SVC()
svc = GridSearchCV(svr, parameters, n_jobs=8)
